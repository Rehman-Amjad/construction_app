...
class TilesController extends GetxController {
  ...
  RxDouble lengthInTileDimensionF = 0.0.obs;
  RxDouble widthInTileDimensionF = 0.0.obs;
  ...
  void getLengthTilesDimensionFeet(value) {
    lengthInTileDimensionF.value = value/12;
  }

  void getWidthTilesDimensionFeet(value) {
    widthInTileDimensionF.value = value/12;
  }
  ...
  void calculationsForFeet() {
    ...
    double totalAreaOfOneTileInFt =
        lengthInTileDimensionF.value * widthInTileDimensionF.value;
  ...
  void calculationsForMeters() {
    ...
    num totalAreaOfOneTileInM = (lengthInTileDimension.value / 100) *
        (widthInTileDimension.value / 100);
    // Calculate the Number of Tiles:

    numOfTiles.value = totalArea.value /
        num.tryParse(totalAreaOfOneTileInM.toStringAsFixed(2))!;
